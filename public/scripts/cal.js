  ...
  function showbmi(){
  document.querySelector("#bmi").removeAttribute("hidden");
  document.querySelector("#cal").setAttribute("hidden",true);
  }
	function showcal(){
  document.querySelector("#cal").removeAttribute("hidden");
  document.querySelector("#bmi").setAttribute("hidden",true);
  }
	var cneed;
var fneed;
var crneed;
